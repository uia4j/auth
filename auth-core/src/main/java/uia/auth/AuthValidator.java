...
public class AuthValidator {
    ...
    public AuthValidator and(String funcName) throws SQLException {
    ...
    public AuthValidator or(String funcName) throws SQLException {
    ...
    private AuthUserPower search(String funcName) throws SQLException {
        AuthUserPower fua = null;

        AuthFuncUserView fuv = this.fuvDao.select(funcName, this.userId);
        AuthFuncRoleUserView fruv = this.fruvDao.select(funcName, this.userId);
        if (fuv != null) {
